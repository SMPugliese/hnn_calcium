...
class MorletSpec():
    ...
    def plot_to_ax(self, ax_spec, dt):
        ...
        pc = ax_spec.imshow(self.TFR, aspect='auto', origin='upper', norm=plt.colors.Normalize(vmin=0,vmax=90000), cmap=plt.get_cmap('jet'))
...
class Spec():
    ...
    def plot_TFR(self, ax, layer='agg', xlim=None, ylim=None):
        ...
        # plot
        im = ax.imshow(dcut['TFR'], extent=extent_xy, aspect='auto', origin='upper', norm=plt.colors.Normalize(vmin=0,vmax=90000), cmap=plt.get_cmap('jet'))
...
def pspec_ax(ax_spec, fspec, xlim, layer=None):
    ...
    pc = ax_spec.imshow(TFR, extent=extent_xy, aspect='auto', origin='upper', norm=plt.colors.Normalize(vmin=0,vmax=90000), cmap=plt.get_cmap('jet'))
